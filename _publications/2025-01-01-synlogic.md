...
This paper addresses the challenge of creating large-scale, verifiable reasoning datasets to advance logical reasoning capabilities in language models. Our approach provides a framework for synthesizing high-quality reasoning data that can be used to train and evaluate models on complex logical tasks.
